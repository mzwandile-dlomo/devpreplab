...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("Logged in successfully. Token stored in local storage.");
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-8">
      <h1 className="mb-4 text-xl font-semibold text-white text-center">Login</h1>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-1">
          <label
            className="block text-xs font-medium text-zinc-300 text-center"
            htmlFor="email"
          >
            Email
          </label>
